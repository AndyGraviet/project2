...
function DataPage() {
  return (
    <div className="content">
      <FadeIn>
        <b>
          Over 50% of identified girl victims are aged between 15 and 17 while
          about 40% of trafficked boys are under 12 years of age.
        </b>{" "}
        The data in the table below only reflects cases recorded in Utah.
        <section>
          <table>
            <th>Date Missing</th>
            <th>Last Name</th>
